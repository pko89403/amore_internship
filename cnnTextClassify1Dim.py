...
def CNN(max_len, max_words):
	...
	conv_0 = Conv1D(filters=512, kernel_size=4, padding='valid', kernel_initializer='normal', activation='relu')(embedding)
	conv_1 = Conv1D(filters=512, kernel_size=6, padding='valid', kernel_initializer='normal', activation='relu')(embedding)
	conv_2 = Conv1D(filters=512, kernel_size=8, padding='valid', kernel_initializer='normal', activation='relu')(embedding)
