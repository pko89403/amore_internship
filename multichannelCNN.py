...
def MultiChannelCNN1(X_train, Y_train, X_test, Y_test):
    ...
    conv_2 = Conv1D(filters=filterCnt , kernel_size={{choice([2,3,4,5,6])}}, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding)
    ...
    conv_20 = Conv1D(filters=filterCnt , kernel_size={{choice([2,3,4,5,6])}}, padding='valid', kernel_regularizer='l2', activation='relu')(embedding2)
    conv_20_bn = BatchNormalization()(conv_20)

    conv_21 = Conv1D(filters=filterCnt , kernel_size={{choice([2,3,4,5,6])}}, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding2)
    conv_21_bn = BatchNormalization()(conv_21)

    conv_22 = Conv1D(filters=filterCnt , kernel_size={{choice([2,3,4,5,6])}}, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding2)
