...
def CNN(max_words):
    ...
    conv_0 = Conv1D(filters=128, kernel_size=2, padding='valid', activation='relu')(Reshaped)
    conv_01 = Conv1D(filters=128, kernel_size=2, padding='valid', activation='relu')(conv_0)
    maxpool_01 = MaxPool1D(pool_size=2, padding='valid')(conv_01)
    conv_012 = Conv1D(filters=128, kernel_size=2, padding='valid', activation='relu')(maxpool_01)
    conv_0123 = Conv1D(filters=128, kernel_size=2, padding='valid', activation='relu')(conv_012)
    maxpool_012 = MaxPool1D(pool_size=2, padding='valid')(conv_0123)

    conv_1 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(Reshaped)
    conv_11 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(conv_1)
    maxpool_11 = MaxPool1D(pool_size=2, padding='valid')(conv_11)
    conv_112 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(maxpool_11)
    conv_1123 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(conv_112)
    maxpool_112 = MaxPool1D(pool_size=2, padding='valid')(conv_1123)

    conv_2 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(Reshaped)
    conv_21 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(conv_2)
    maxpool_21 = MaxPool1D(pool_size=2, padding='valid')(conv_21)
    conv_212 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(maxpool_21)
    conv_2123 = Conv1D(filters=128, kernel_size=3, padding='valid', activation='relu')(conv_212)
