...
conv_1 = Conv1D(filters=256, kernel_size=3, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding)
conv_1_bn = BatchNormalization()(conv_1)
conv_1_bn = Dropout(0.5)(conv_1_bn)

conv_2 = Conv1D(filters=256, kernel_size=4, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding)
...
conv_20 = Conv1D(filters=256, kernel_size=2, padding='valid', kernel_regularizer='l2', activation='relu')(embedding2)
conv_20_bn = BatchNormalization()(conv_20)
conv_20_bn = Dropout(0.5)(conv_20_bn)

conv_21 = Conv1D(filters=256, kernel_size=3, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding2)
conv_21_bn = BatchNormalization()(conv_21)
conv_21_bn = Dropout(0.5)(conv_21_bn)

conv_22 = Conv1D(filters=256, kernel_size=4, padding='valid',  kernel_regularizer='l2', activation='relu')(embedding2)
